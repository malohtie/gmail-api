    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <select id="accounts" class="form-control selectpicker" data-live-search="true" data-actions-box="true"
                        multiple>
            ...
            <div class="form-group">
                ...
                <input type="text" id="from" class="form-control" placeholder="costo"/>
            </div>
            <div class="form-group">
            ...
            if (accounts.length > 0) {
                ...
                if (from) {
                    ...
                    $.each(accounts, (i, v) => {
                        ...
                        $.ajax({
                            url: "{{ route('froms.make', ':id') }}".replace(":id", v),
                            method: "post",
                            dataType: "json",
                            data: {
                                from
